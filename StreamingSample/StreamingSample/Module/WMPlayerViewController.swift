...
public protocol WMPlayerViewControllerDelegate: AnyObject {
    func playerReady(_ player: WMPlayerViewController)
    func playerPlaybackStateDidChange(_ player: WMPlayerViewController)
    func playerBufferingStateDidChange(_ player: WMPlayerViewController)
    ...
    func player(_ player: WMPlayerViewController, didFailWithError error: Error?)
}

public protocol WMPlayerViewControllerPlaybackDelegate: AnyObject {
    func playerCurrentTimeDidChange(_ player: WMPlayerViewController)
    func playerPlaybackWillStartFromBeginning(_ player: WMPlayerViewController)
    func playerPlaybackDidEnd(_ player: WMPlayerViewController)
    func playerPlaybackWillLoop(_ player: WMPlayerViewController)
    func playerPlaybackDidLoop(_ player: WMPlayerViewController)
}

// MARK: - Player

/// ▶️ Player, simple way to play and stream media
open class WMPlayerViewController: UIViewController {
    ...
    /// Player delegate.
    open weak var playerDelegate: WMPlayerViewControllerDelegate?

    /// Playback delegate.
    open weak var playbackDelegate: WMPlayerViewControllerPlaybackDelegate?
    ...
    open var fillMode: WMPlayerViewController.FillMode {
        get {
...
extension WMPlayerViewController {
...
public class PlayerView: UIView {
    ...
    public var playerFillMode: WMPlayerViewController.FillMode {
        get {
