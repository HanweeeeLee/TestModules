...
class HWTableViewOld: UITableView {
    var obj:HWTableViewDelegateOld = HWTableViewDelegateOld()
...
class HWTableViewDelegateOld:NSObject {
...
extension HWTableViewDelegateOld:UITableViewDataSource {
...
//        cell.hideSkeleton() 이거 호출하면 셀이 이상하게 호출됨 흠....
    ...
    func tableView(_ tableView: UITableView, canMoveRowAt indexPath: IndexPath) -> Bool {
        return self.originDataSource?.tableView?(tableView, canMoveRowAt: indexPath) ?? false
    }
...
extension HWTableViewDelegateOld:UITableViewDelegate {
